...
/***/ "./src/controller/data-publisher.js":
/*!******************************************!*\
  !*** ./src/controller/data-publisher.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/controller/storage-controller.js":
/*!**********************************************!*\
  !*** ./src/controller/storage-controller.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "storageTable": () => (/* binding */ storageTable)
/* harmony export */ });
/* harmony import */ var Modules_project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Modules/project */ "./src/modules/project.js");
/* harmony import */ var Modules_task_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Modules/task.js */ "./src/modules/task.js");
/* harmony import */ var Controller_task_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Controller/task-controller.js */ "./src/controller/task-controller.js");
  ...
  deserialize() {
    ...
    if(jsonParseData) {
      if(this.lStorageTableName === storageTable.projectTable) {
        data = jsonParseData.map((project) => new Modules_project__WEBPACK_IMPORTED_MODULE_0__.Project(project.title, project.description));
      } else {
        data = new Map();
        jsonParseData.forEach((value, key) => {
          ...
          value.forEach(v => {
            ...
            const task = Modules_task_js__WEBPACK_IMPORTED_MODULE_1__.TaskFactory.createTask(v.type, v.id, v.title, v.description, v.dueDate, v.priority);
            task.setDone = v.done;
            task.setExpired = Controller_task_controller_js__WEBPACK_IMPORTED_MODULE_2__.TaskController.getExpired(task.getDueDate);
            if(Modules_task_js__WEBPACK_IMPORTED_MODULE_1__.taskType.note === Modules_task_js__WEBPACK_IMPORTED_MODULE_1__.taskType[v.type]) {
              task.setNote = v.note;
            } else {
...
/* harmony export */   "taskFetchDate": () => (/* binding */ taskFetchDate),
/* harmony export */   "taskSortMode": () => (/* binding */ taskSortMode)
/* harmony export */ });
/* harmony import */ var Modules_task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Modules/task.js */ "./src/modules/task.js");
/* harmony import */ var Controller_storage_controller_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Controller/storage-controller.js */ "./src/controller/storage-controller.js");
/* harmony import */ var _data_publisher_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data-publisher.js */ "./src/controller/data-publisher.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/startOfWeek/index.js");
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isToday/index.js");
...
class TaskController {
  constructor() {
    ...
    this.dataPublisher = new _data_publisher_js__WEBPACK_IMPORTED_MODULE_2__.DataPublisher();
    this.storageController = new Controller_storage_controller_js__WEBPACK_IMPORTED_MODULE_1__.StorageController('taskTable');
    this.taskPriorityLevel = new Map();
    let level = 0;
    this.expirationTimerNotifier = new _data_publisher_js__WEBPACK_IMPORTED_MODULE_2__.DataPublisher();
    this.expirationTimerObserver = null;
    this.expirationTimer = -1;
    for (const property in Modules_task_js__WEBPACK_IMPORTED_MODULE_0__.taskPriority) {
  ...
  checkDueDateInterval(task, mode, now = new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'yyyy-MM-dd') + "T00:00:00")) {
    ...
    switch(taskFetchDate[mode]) {
      case taskFetchDate.week:
        isContained = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.getDueDate + "T00:00:00"), {
          start: (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(now),
          end: (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(now)
        });
        break;
      case taskFetchDate.month:
        isContained = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(task.getDueDate + "T00:00:00"), {
          start: (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(now),
          end: (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(now)
        });
        break;
      case taskFetchDate.today:
      default:
        isContained = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(new Date(task.getDueDate + "T00:00:00"));
        break;
    }
    return isContained;
  }
  fetchByDueDate(mode) {
    ...
    const now = new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'yyyy-MM-dd') + "T00:00:00");
  ...
  createTask(task) {
    const taskType = ((task.list) && (task.list.length > 0))  ? Modules_task_js__WEBPACK_IMPORTED_MODULE_0__.taskType.list : Modules_task_js__WEBPACK_IMPORTED_MODULE_0__.taskType.note;
    const objTask = Modules_task_js__WEBPACK_IMPORTED_MODULE_0__.TaskFactory.createTask(taskType, 
    ...
    if(taskType === Modules_task_js__WEBPACK_IMPORTED_MODULE_0__.taskType.note) {
  ...
  edit(projectKey, oldID, newTask) {
    ...
    if(oldTask.getType !== newTask.getType) {
      ...
      if(newTask.getType === Modules_task_js__WEBPACK_IMPORTED_MODULE_0__.taskType.note) {
  ...
  checkTaskExpired(task) {
    ...
    task.setExpired = (0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(new Date(task.getDueDate + "T00:00:00"), new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'yyyy-MM-dd') + "T00:00:00")) < 0;
  }
  static getExpired(dueDate) {
    if(!dueDate || dueDate === '' || dueDate === 'No due date') return false;
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_11__["default"])(new Date(dueDate + "T00:00:00"), new Date((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), 'yyyy-MM-dd') + "T00:00:00")) < 0;
  }
