...
/* harmony export */   "createEditText": () => (/* binding */ createEditText),
/* harmony export */   "createImageButton": () => (/* binding */ createImageButton),
/* harmony export */   "createRadio": () => (/* binding */ createRadio),
/* harmony export */   "createRadioButton": () => (/* binding */ createRadioButton),
/* harmony export */   "createSelect": () => (/* binding */ createSelect),
/* harmony export */   "createSwitchButton": () => (/* binding */ createSwitchButton),
/* harmony export */   "createTextButton": () => (/* binding */ createTextButton)
/* harmony export */ });
/* harmony import */ var Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Utilities/dom-manager.js */ "./src/utilities/dom-manager.js");
/* harmony import */ var Utilities_button_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Utilities/button.js */ "./src/utilities/button.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/format/index.js");




function createEditText(editTextID, placeHolderText, labelText = null, required = true) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const input = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeID('input', editTextID);
  ...
  if(label) {
    if(required) {
      Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createAddNode('span', label, 'required', null, '*');
    }
...
function createDate(dateID, labelText = null, startFromToday = true, required = true) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const input = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeID('input', dateID);
  input.setAttribute('type', 'date');
  input.required = required;
  /* Set minimum date */
  if(startFromToday) {
    input.setAttribute('min', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'yyyy-MM-dd'));
  }
  /* Set label when node exists */
  if(label) {
...
function createCheckBox(checkBoxID, labelText = null, cbEvent = undefined, isChecked = false, required = false) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const input = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeID('input', checkBoxID);
...
function createButton(btnID, btnText = '', svgIconFileName = null, className = null, 
                             cbEvent = undefined, formItem = null, labelText = null, required = false) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const input = Utilities_button_js__WEBPACK_IMPORTED_MODULE_1__.createButton(btnText, svgIconFileName, className, (!formItem ? cbEvent : undefined));
...
function createImageButton(btnID, svgIconFileName, className = null, cbEvent = undefined, 
...
function createTextButton(btnID, btnText, className = null, cbEvent = undefined, 
                                 formItem = null, labelText = null, required = false) {
  return createButton(btnID, btnText, null, className, cbEvent, formItem, labelText, required);
}

function createSwitchButton(switchID, isRoundSwitch = false, labelText = null, 
                                   cbEvent = undefined, isChecked = false, required = false) {
  const labelSwitch = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNode('label', 'switch');
  const checkBox = createCheckBox(switchID, labelText, cbEvent, isChecked, required);
  Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.addNodeChild(labelSwitch, checkBox.input);      
  Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createAddNode('span', labelSwitch, (isRoundSwitch ? 'slider round' : 'slider'));
  return { label: checkBox.label, input: labelSwitch, checkbox: checkBox.input };
}

function createRadio(radioID, value, labelText = null, cbEvent = undefined, isChecked = false, required = false) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const input = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeID('input', radioID);
...
function createRadioButton(radioID, value, labelText = null, cbEvent = undefined, isChecked = false, required = false) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const radioBtn = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNode('div', 'radio-btn');
  const radio = createRadio(radioID, value, value, cbEvent, isChecked, required);
  Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.addNodeChild(radioBtn, radio.input);  
  Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.addNodeChild(radioBtn, radio.label);  
  /* Set label when node exists */
  if(label) {
    label.htmlFor = radioID;
  }
...
function createSelect(selectID, values, selectedValue = null, labelText = null, required = false) {
  const label = labelText ? Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('label', labelText) : null;
  const input = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeID('select', selectID);
  input.setAttribute('type', 'radio');
  values.forEach(v => {
    const option = Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.createNodeContent('option', v);
    option.setAttribute('value', v);
    if(selectedValue && v === selectedValue) {
      option.setAttribute('selected', true);
    }
    Utilities_dom_manager_js__WEBPACK_IMPORTED_MODULE_0__.addNodeChild(input, option);
  })
  input.required = required;
